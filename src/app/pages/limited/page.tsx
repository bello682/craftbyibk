      ...
      <main className="pt-32 pb-20 px-6 md:px-10 lg:px-16 max-w-[1440px] mx-auto">
            ...
            >
              ...
              <div className="lg:col-span-7 group relative cursor-crosshair">
                <div className="aspect-[16/10] bg-zinc-900 rounded-[40px] overflow-hidden relative">
                  {/* Replace with <Image /> */}
                  <div className="absolute inset-0 flex items-center justify-center text-zinc-800 font-black uppercase text-4xl tracking-widest group-hover:scale-110 transition-transform duration-700">
                    {product.name}
                  </div>
        ...
        <section className="mt-40 border-t border-zinc-900 pt-24 text-center">
          ...
          <div className="max-w-md mx-auto flex gap-4">
            ...
            />
            <button className="bg-white text-black w-14 h-14 rounded-full flex items-center justify-center hover:scale-105 transition-transform">
