...
import { uploadShopProduct } from "../../../../lib/store/redux/adminSlice";
import { motion, AnimatePresence } from "framer-motion";
import { Plus, Store, Package, Trash2, ListPlus } from "lucide-react";
...
export default function ShopPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await dispatch(uploadShopProduct(data) as any).unwrap();
      setStatus({
        type: "success",
        msg: "SHOP PRODUCT PUBLISHED SUCCESSFULLY",
      });
      ...
      setStatus({
        type: "error",
        msg: error?.payload || error?.message || "FAILED TO PUBLISH TO SHOP.",
      });
    } finally {
      setIsLoading(false);
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          ...
          <Store size={40} className="text-zinc-200 hidden md:block" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
            ...
            <div className="space-y-8">
              <div className="group">
                ...
                <input
                  ...
                  required
                  value={formData.name}
                  placeholder="E.G. LUXE OVERSIZED SHIRT"
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                      {files[view] ? (
                        ...
                        <>
                          <Plus
                            size={20}
                            className="mb-2 transition-transform text-zinc-400"
                          />
          ...
          <div className="flex flex-col items-end gap-4 pt-12 border-t-2 border-zinc-100">
            ...
            >
              {isLoading ? "UPLOADING..." : "Publish to Shop"}
            </button>
          </div>
        </form>
      </div>
